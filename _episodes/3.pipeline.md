...
### Test that the downloaded images work
...
### Containerise the pipeline - first pass
...
### Containerise the pipeline - second pass
...
Let's make a new copy of the pipeline script (if you had troubles, you can pick it up from `solutions/pipe.1.sh`):
