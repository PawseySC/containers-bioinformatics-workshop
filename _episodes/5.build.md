...
6. **Abstract package versions if you can**
    ...
    In the `best_practices` subdirectory of your current work directory, you can find a final version of a Dockerfile for samtools, that implements all the best practices described here.
