...
* configure and compile htslib, a companion library.
...
> 
> Now grab all of the remaining commands from the reference bash script, and insert them in the Dockerfile, each with its own Docker instruction.
> 
> > ## Solution
> > 
> > ```
