...
1. Our local machine needs an X11 system.  Linux boxes should all be good to go.  On macOS we'll need [XQuartz](https://www.xquartz.org); on Windows we'll need [MobaXterm](https://mobaxterm.mobatek.net) or [Cygwin/X](https://x.cygwin.com).  
