...
> 
> **Hints**:
> * define it as `SINGULARITYENV_PASSWORD`, this is a good practice to ensure it's always passed in the container, even if we're enabling further container isolation (see later on);
