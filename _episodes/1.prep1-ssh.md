...
Assume the compressed file is named `rsa_bio.zip`.  This is a SSH key, *i.e.* a way to enforce security measures when connecting to remote computers such as cloud VMs.  
